function Finding_channels_and_rotate_2022_11_10_v1(varargin)
...
base_name_pre=dir('*w1Phase_s1_t1.tif');
...
if sp==0
    D_stagepos=dir('*w1Phase_s*_t1.tif');
...
for do_now=1:length(pos_to_do)
    ...
    try
        ...
        Crop_Frames_func_1_2022_11_10_v1(pos_to_do(do_now),dbs,edge_crop,image_folder,crop_folder,frames, w1, w2,out_name,chanwidth )
    end
end      
